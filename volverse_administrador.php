...
<div class="row">
    ...
    if ( ($filas>0) && ($pass=='SuperPassGranados') ) {
    
        $consulta= "UPDATE users SET tipo_usuario='admin' WHERE correo='$correo'";
        $resultado= mysqli_query($conexion,$consulta);
    

    
         ?>
         <h3 class="orange-text center"><b>¡Ahora usted es administrador!</b></h3>
        ...
        ?>
            <h3 class="orange-text center"><b>Error en la actualizacion de los privilegios de la cuenta</b></h3>
    ...
    <div class="row">
        <div class="col s12 m8 offset-m2 center">
            <h3><b>Introduzca la super contraseña</b></h3>
            <div class="col s12 m6 offset-m3">
                <form  action="volverse_administrador.php" method="POST">
