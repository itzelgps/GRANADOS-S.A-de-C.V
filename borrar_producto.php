...
<div class="row">
  ...
  <div id="derecha" class="col s12 m6 offset-m3">
                                                            ...
                                                            <h3 class="orange-text center">Confirma que desea eliminar el producto: <span class="red-text"><?php echo $fila['nombre']?></span></h3>
                                                            <form class="center" action="eliminar_producto.php" method="POST">
                                                                ...
                                                                <br>
                                                                    <p style="text-align: center" > <input style="display:none;" id="entradas" class="white orange-text" value="<?php echo $fila['id']?>" type="text" name="id_eliminar" size="100" required placeholder="Ingrese su nombre"></p>
                                                                        ...
                                                                        <a class="btn green" href="productos_admin.php"> Cancelar </a>
