        ...
        <div class="row">
            <div class="col s8 m6 offset-s2 offset-m4 ">
                    <div class="col s12 m7" >
                            <h2 class="header orange-text center">¡Su cuenta ha sido activada con éxito!</h2>
                            ...
                            <div class="card-stacked">
                                ...
                                <p>A partir de ahora puedes logearte y disfrutar de todos nuestros servicios </p>
                                </div>
