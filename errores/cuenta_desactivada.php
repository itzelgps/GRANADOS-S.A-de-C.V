        ...
        <div class="row">
            <div class="col s8 m6 offset-s2 offset-m4 ">
                    <div class="col s12 m7" >
                            <h2 class="header orange-text center">¡La cuenta a la que intentas acceder <span style="color: red">NO </span> ha sido activada!</h2>
                            ...
                            <div class="card-stacked">
                                ...
                                <p> Se te envió un correo con un código de confirmación para activar la cuenta </p>
                                <p> En caso de no contar con el correo, contacta con un administrador en la sección: contacto. </p>
                                </div>
