        ...
        <div class="row">
            <div class="col s8 m6 offset-s2 offset-m4 ">
                    <div class="col s12 m7" >
                            <h2 class="header orange-text center">Error en la activacion de la cuenta</h2>
                            ...
                            <div class="card-stacked">
                                ...
                                <p>Verifique su correo electrónico y el código de verificación </p>
                                </div>
                                <div class="card-action center">
                                <a href="../confirmacion.php">Reintentar</a>
                                </div>
                            </div>
                            </div>
                        </div>
